...
def load_and_sample_datasets(cfg):
    ...
    harmless_self_consistency = load_dataset("self_consistency_benign")
    harmful_self_consistency = load_dataset("self_consistency_harm")

    return harmful_train, harmless_train, harmful_val, harmless_val, harmful_self_consistency, harmless_self_consistency
...
def generate_and_save_candidate_directions(cfg, model_base, harmful_train, harmless_train, self_consistency=False):
    """Generate and save candidate directions."""
    suffix = "_self_consistency" if self_consistency else ""
    ...
    torch.save(mean_diffs, os.path.join(cfg.artifact_path(), f'generate_directions/mean_diffs{suffix}.pt'))
...
def run_pipeline(model_path):
    ...
    harmful_train, harmless_train, harmful_val, harmless_val, harmful_self_consistency, harmless_self_consistency = load_and_sample_datasets(cfg)
